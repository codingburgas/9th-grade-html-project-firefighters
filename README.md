...
##  About
Firefighters is part of a worldwide safety act which focuses on reporting and informing the locals of a selected area about wildfires, catastrophes, etc.
...
<table>
  ...
  <tr>
    <td align="center"><img src="https://avatars.githubusercontent.com/u/172926820?v=4" width="50" height="50" ></td>
    <td><b>Mihail Karanikolov</b></td>
    <td>Scrum Trainer, FrontEnd Developer</td>
    <td><span style="background-color: red; color: white; padding: 5px 10px; border-radius: 5px;">9G</span></td>
    <td>https://github.com/MYAKaranikolov23</td>
  </tr>
  <tr>
...
## Features
 Articles about how to act in different dangerous situations.  <br>
 Reporting system.  <br>
 Diagram of recent reports. <br>

## Used Technologies/Apps

- <img src="https://upload.wikimedia.org/wikipedia/commons/9/9a/Visual_Studio_Code_1.35_icon.svg" width="25" height="25"> Visual Studio Code <br>
